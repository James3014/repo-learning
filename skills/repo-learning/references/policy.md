...
Prefer delayed review in a naturally occurring real case. Synthetic variants are fallback only. Do not claim silent cue-fading suppression from chat memory alone; require current bounded concept-level learning evidence that explicitly marks silent cue fading eligible.
